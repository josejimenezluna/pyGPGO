...
\begin{titlepage}
	...
	{\scshape\LARGE Universitat Politecnica de Catalunya\par
	 Facultat de Matematiques i Estadistica\par}
	\vspace{1cm}
	{\scshape\Large Final Master's Thesis (MESIO)\par}
	\vspace{1.5cm}
	{\huge\bfseries Bayesian optimization in machine learning\par}
	\vspace{2cm}
	{\Large\itshape José Jiménez\par}
...
\begin{quotation}
\noindent Blablablabla eqweqweqs qeqdqw
\end{quotation}
\clearpage
